...
class AWG5014BTest(DeviceServerTestCase):
	...
	def testMarkerValues(self):
		...
		assert_almost_equal(awg.channels[1].markers[2].delay.value, 0.1e-9)
		eq_(awg.channels[2].markers[1].delay.value, 0)
		eq_(awg.channels[2].markers[2].delay.value, 0)

		assert_almost_equal(awg.channels[1].markers[1].high.value, 0.5)
		...
		assert_almost_equal(awg.channels[2].markers[1].low.value, -0.1)
