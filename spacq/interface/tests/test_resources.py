...
class ResourceTest(TestCase):
	...
	def testConverter(self):
		...
		assert_equal(res2.convert('5'),5)
		assert_almost_equal(res3.convert('5') / 2, 2.5)
	...
	def testSweep(self):
		...
		buf = []
		res.sweep(1.0, 5.0, 5)
		eq_(buf, list(linspace(1.0, 5.0, num=5)))
		...
		eq_(buf, list(linspace(-5.0, 5.0, num=11)))
		...
		eq_(buf, list(linspace(9.0, 10.0, num=2)))
